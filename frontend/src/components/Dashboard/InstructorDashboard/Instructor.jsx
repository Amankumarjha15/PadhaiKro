...
export default function Instructor() {
  ...
  return (
    <div className="w-full">
      ...
      {loading ? (
        <div className="spinner w-full flex justify-center py-12"></div>
      ) : courses.length > 0 ? (
        <div>
          <div className="my-4 flex flex-col lg:flex-row h-auto lg:h-[450px] gap-4">
            ...
            {totalAmount > 0 || totalStudents > 0 ? (
              ...
              <div className="w-full lg:w-2/3 rounded-md bg-richblack-800 p-4 md:p-6">
                <p className="text-lg font-bold text-richblack-5">Visualize</p>
                <p className="mt-4 text-xl font-medium text-richblack-50">
                  Not Enough Data To Visualize
                </p>
            ...
            {/* Total Statistics */}
            <div className="w-full lg:w-1/3 flex flex-col rounded-md bg-richblack-800 p-4 md:p-6">
              <p className="text-lg font-bold text-richblack-5">Statistics</p>
        ...
        <div className="mt-10 md:mt-20 rounded-md bg-richblack-800 p-6 py-12 md:py-20">
          <p className="text-center text-xl md:text-2xl font-bold text-richblack-5">
            You have not created any courses yet
          </p>
          <Link to="/dashboard/add-course">
            <p className="mt-1 text-center text-base md:text-lg font-semibold text-yellow-50">
              Create a course
            </p>
          </Link>
        </div>
